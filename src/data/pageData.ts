...
export const ksiData = [
  {
    title: '공통 운영 작업',
    description: [
      'SCSS 변수·믹스인 기반 스타일 모듈화로 모바일·태블릿·PC 대응 반응형 웹 구현 및 다수 사이트 스타일 일관성 확보',
      '테이블 기반 레이아웃을 시맨틱 구조로 전환하고 SEO 친화적 마크업 적용',
      'Google Search Console·네이버 서치어드바이저 등록 및 robots.txt·사이트맵 설정으로 검색 노출 환경 구성',
      '폼 마크업·비회원 분기 처리·결제 연동(이지페이·토스)으로 사전등록·초록등록·회비납부 기능 구현',
      '학회와 직접 소통하며 요구사항 수집부터 단가 안내, DB 이전, 도메인 연결, SSL 적용까지 오픈 전 과정 주도적으로 조율',
    ],
  },
  {
    title: '한국보건행정학회',
...
export const ksiJournalData = [
  {
    title: '논문 투고 시스템',
    description: [
      '투고자·심사위원·편집위원·편집위원장 역할별 워크플로우를 파악하고, 각 역할 및 투고 단계에 맞는 관리자 UI를 커스터마이징했습니다.',
      '테이블·모달·상태 뱃지 등 관리자 화면 UI 컴포넌트를 학회별 요구사항에 맞게 퍼블리싱했습니다.',
      '메일·알림·결제 시스템 등 운영 환경 파악 및 초기 세팅 가이드를 작성하여 학회에 전달했습니다.',
      'KISS 검색 위젯·링크 연동으로 홈페이지와 논문 검색 환경을 통합했습니다.',
    ],
