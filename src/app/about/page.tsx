          ...
          <div className={s.workExperience}>
            ...
            <ul className={s.aboutbox}>
              <li>
                ...
                <h3 className={s.title}>
                  <em>커넥트웨이브</em> <span>프론트엔드(UI 개발) 2025.05 ~ 2026.03</span>
                </h3>
                <div className={s.description}>
              ...
              <li>
                ...
                <div className={s.description}>
                  <p>총 37개 학회·연구원 홈페이지와 논문 투고 시스템 구축 및 유지보수</p>
                  ...
                  <p>폼 마크업 및 비회원 분기 처리, 결제 연동 화면 퍼블리싱으로 사전등록·회비납부 기능 구현</p>
                  <p>학회와 직접 소통하며 요구사항 수집 및 오픈 일정 조율을 담당하고, DB 이전·도메인 연결·SSL 적용 과정에서 백엔드와 협업하여 구축 지원</p>
