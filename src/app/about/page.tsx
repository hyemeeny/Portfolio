      ...
      <Container>
        ...
        <Tag tagName="heaeder" hasAttr attr="class" attrValue="자기소개" padding="large">
          <ul className={s.introduce}>
            <li>
              <p>안녕하세요! 👋</p>
              <p>아토믹 디자인 패턴을 바탕으로 작은 단위의 컴포넌트 개발을 좋아하는 4년차 퍼블리셔이자 프론트엔드 개발자 지혜민입니다.</p>
            </li>
            <li>
          ...
          <div className={s.workExperience}>
            ...
            <ul className={s.aboutbox}>
              <li>
                ...
                <div className={s.description}>
                  <p>React 기반 AI 노코드 이미지 제작 솔루션 프로젝트에 참여하여 블록 단위 상세 페이지 스킨 설계 및 퍼블리싱 수행</p>
                  <p>재사용 가능한 UI 가이드 및 컴포넌트 시스템을 구축해 일관된 디자인과 효율적인 개발 환경 지원</p>
                  <p>자사 React 웹사이트 유지보수와 2.0 솔루션의 반응형 레이아웃 및 UI 컴포넌트 개선을 통해 UI/UX 고도화에 기여</p>
                  <p>프로모션 이벤트 페이지를 퍼블리싱하며 다양한 브라우저와 디바이스 환경에서 접근성을 강화하고, 사용자 유입률 향상에 기여</p>
                  <p>Git/GitHub을 활용한 형상 관리와 Jira 기반의 협업으로 개발자·기획·디자인 팀 간 원활한 커뮤니케이션 수행</p>
                </div>
              </li>
              <li>
                <h3 className={s.title}>
              ...
              <li>
                ...
                <div className={s.description}>
                  ...
                  <p>기획·디자인·개발 팀과 협업하여 고객 맞춤형 UI/UX를 구현하고 페이지 최적화를 통해 사용자 유입률 13% 증가</p>
                </div>
              </li>
              <li>
                <h3 className={s.title}>
