          ...
          <div className={s.workExperience}>
            ...
            <ul className={s.aboutbox}>
              ...
              <li>
                ...
                <div className={s.description}>
                  <p>인터넷 면세점 사이트 유지보수 및 이벤트·프로모션 페이지 퍼블리싱</p>
                  <p>JSP 기반 환경에서 마크업 구조 개선 및 스타일 코드 정리로 UI 일관성 확보</p>
                  <p>슬라이드·팝업·탭·플로팅 배너 등 인터랙티브 UI 수정 및 PC·모바일 반응형 대응</p>
                  <p>기획·디자인·개발 팀과 협업하여 이벤트·프로모션 페이지 퍼블리싱 및 기능 연동 지원</p>
                </div>
              </li>
            </ul>
          </div>
